...
EGO_SESSION_EVENT_FLAG_STORAGE_REQUESTED = 1 << 0
EGO_SESSION_EVENT_FLAG_STORAGE_ACTIVE = 1 << 1
EGO_SESSION_EVENT_FLAG_STORAGE_ERROR = 1 << 2
EGO_SESSION_EVENT_FLAG_STORAGE_TCP_FALLBACK = 1 << 3
EGO_IMU_CALIBRATION_FLAG_BOOT = 1 << 0
EGO_IMU_CALIBRATION_FLAG_MANUAL = 1 << 1
EGO_IMU_CALIBRATION_FLAG_GYRO_BIAS_VALID = 1 << 2
EGO_IMU_CALIBRATION_FLAG_ACCEL_REF_VALID = 1 << 3
EGO_IMU_CALIBRATION_FLAG_LOW_SAMPLE_COUNT = 1 << 4
EGO_CAN_STATUS_RUNNING = 1 << 0
EGO_CAN_STATUS_DISABLED = 1 << 1
